  ...
  <div class="bestseller_miniimg">
    <div class="slider">
    	<div><img src="../../images/1.PNG" usemap="#Map" onerror="javascript:this.src='../../images/1.png'" border="0"/>
          <map name="Map" id="Map">
            <area shape="rect" coords="149,5,931,555" href="../itempage/detail.jsp?productId=26" />
            <area shape="rect" coords="970,5,1751,555" href="../itempage/detail.jsp?productId=27" />
          </map>
    	</div>
    	<div><img src="../../images/2.PNG" usemap="#Map2" onerror="javascript:this.src='../../images/2.png'" border="0"/>
          <map name="Map2" id="Map2">
            <area shape="rect" coords="151,4,930,555" href="../itempage/detail.jsp?productId=31" />
            <area shape="rect" coords="969,4,1751,555" href="../itempage/detail.jsp?productId=30" />
          </map>
    	</div>
    	<div><img src="../../images/3.PNG" usemap="#Map3" onerror="javascript:this.src='../../images/3.png'" border="0"/>
          <map name="Map3" id="Map3">
            <area shape="rect" coords="970,3,1749,552" href="../itempage/detail.jsp?productId=3" />
            <area shape="rect" coords="149,4,931,553" href="../itempage/detail.jsp?productId=32" />
          </map>
    	</div>
    	<div><img src="../../images/4.PNG" usemap="#Map4" onerror="javascript:this.src='../../images/4.png'" border="0"/>
          <map name="Map4" id="Map4">
            <area shape="rect" coords="149,4,930,553" href="../itempage/detail.jsp?productId=33" />
            <area shape="rect" coords="969,3,1749,551" href="../itempage/detail.jsp?productId=11" />
          </map>
    	</div>
    </div>
  </div>
